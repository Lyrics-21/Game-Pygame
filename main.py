...
#Menu
sound_menu = pygame.mixer.Sound("Recursos/Menu/Sounds/Sound_menu.mp3")
sound_menu_click = pygame.mixer.Sound("Recursos/Menu/Sounds/Sound_menu2.mp3")
sound_flag_menu = True

menu_activo = True
menu = pygame.image.load("Recursos/Menu/menu_god.png")
menu = pygame.transform.scale(menu,(W,H))
icono = py.image.load("Recursos/Menu/icon.png")
...
sound_pasos = pygame.mixer.Sound("Recursos/Sonidos/run.mp3")
