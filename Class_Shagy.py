...
class Shagy(Personaje):
    def __init__(self, acciones, escala, pos_x, pos_y, velocidad, plataformas_right_left, vida): 
        ...
        self.sound_golpe_shagy = pygame.mixer.Sound("Recursos/Sonidos/Golpe.mp3")
        self.sound_item = pygame.mixer.Sound("Recursos/Sonidos/itemsound.mp3")
        self.sound_explosion = pygame.mixer.Sound("Recursos/Sonidos/explosion.mp3")
        self.sound_muerte_shagy = pygame.mixer.Sound("Recursos/Sonidos/muerte shagy.mp3")
