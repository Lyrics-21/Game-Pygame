...
class Disparo:
    def __init__(self, x, y, direccion, escala):
        self.rect_item, self.item = crear_item("Recursos/Items/Proyectil.png", escala, x, y)
        self.rect_item, self.item_shagy = crear_item("Recursos/Items/pancho.png", escala, x, y)
        self.item_golpe = pygame.image.load("Recursos/Items/golpe.png")
